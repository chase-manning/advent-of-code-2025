...
def test():
    ...
    print(f"Day 2 - Part 1: {result_part1} (expected: {expected_part1})")
    print(f"Day 2 - Part 2: {result_part2} (expected: {expected_part2})")
